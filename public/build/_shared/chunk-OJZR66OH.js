...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1774557886808.3765";
}
var buttonVariants = cva("inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50", {
  variants: {
    variant: {
      default: "bg-[#1DA2AC] text-white shadow hover:bg-[#1DA2AC]/90",
      accent: "bg-[#FCB813] text-gray-900 shadow-sm hover:bg-[#FCB813]/90",
      destructive: "bg-red-500 text-white shadow-sm hover:bg-red-500/90",
      outline: "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
      secondary: "bg-[#687A7C] text-white shadow-sm hover:bg-[#687A7C]/80",
      ghost: "hover:bg-accent hover:text-accent-foreground",
      link: "text-[#1DA2AC] underline-offset-4 hover:underline"
    },
    size: {
...
//# sourceMappingURL=/build/_shared/chunk-OJZR66OH.js.map
